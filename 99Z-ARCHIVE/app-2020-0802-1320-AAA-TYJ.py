...
servo_02 = Servo(myGPIO_02,min_pulse_width=minPW,max_pulse_width=maxPW)
...
def motor():
    ...
    if left and not cfg.chocks:
        ...
        if left_Int >= -100 and left_Int <= 100:
            ...
            if left_Int >= 0:
                ...
                robohat.motorLeft_Plus_Fn(left_Absolute)
                # Sample Test Servo
                ...
                robohat.motorLeft_Minus_Fn(left_Absolute)
                # Sample Test Servo
    ...
    if right and not cfg.chocks:
        ...
        if right_Int >= -100 and right_Int <= 100:
            ...
            if right_Int >= 0:
                robohat.motorRight_Plus_Fn(right_Absolute)
                # Sample Test Servo
                ...
                robohat.motorRight_Minus_Fn(right_Absolute)
                # Sample Test Servo
